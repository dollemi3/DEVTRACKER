...
CREATE TABLE `User` (
    ...
    `statusMessage` VARCHAR(191) NULL DEFAULT '',
    `profileImage` VARCHAR(191) NULL DEFAULT '',
    `usingTech` VARCHAR(191) NULL DEFAULT '[]',
...
-- AddForeignKey
ALTER TABLE `Comment` ADD CONSTRAINT `Comment_codeId_fkey` FOREIGN KEY (`codeId`) REFERENCES `CodeSnippet`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
